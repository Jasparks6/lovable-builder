...
export default async function handler(req, res) {
  ...
  // 1. Pull website copy from Supabase leads table
  ...
  // 3. Construct your custom prompt
  const prompt = `
...
`;
  ...
  // 4. Launch Puppeteer and build site
